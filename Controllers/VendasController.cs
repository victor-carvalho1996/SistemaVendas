...
namespace VendasSolutto.Controllers
{
    public class VendasController : Controller
    {
        ...
        public VendasController(VendasSoluttoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,cliente_cnpj,data_venda,quantidade_pagamentos")] Vendas vendas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,cliente_cnpj,data_venda,quantidade_pagamentos")] Vendas vendas)
        {
            if (id != vendas.id)
            {
                return NotFound();
